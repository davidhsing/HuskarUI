...
T.Control {
    ...
    property int lineStyle: HusTree.LineSolid
    ...
    property HusMargin marginIcon: HusMargin { left: 2 }
    property HusMargin marginText: HusMargin { left: 3 }
    property var themeSource: HusTheme.HusTree
    ...
    property Component nodeContentDelegate: Item {
        ...
        RowLayout {
            ...
            HusText {
                ...
                Layout.topMargin: control.marginText.top
                Layout.bottomMargin: control.marginText.bottom
                Layout.leftMargin: __icon.visible ? 0 : control.marginText.left
                Layout.rightMargin: control.marginText.right
                // padding: 2
                font: control.font
                text: treeData?.title ?? ''
            ...
            RowLayout {
                ...
                Item {
                    ...
                    Loader {
                        ...
                        active: control.lineVisible && !__rootItem.isRootNode
                        visible: active
                ...
                Item {
                    ...
                    Loader {
                        ...
                        active: control.lineVisible && __rootItem.isLastNode && __rootItem.hasChildren
                        sourceComponent: LinkLine {
                    ...
                    Loader {
                        ...
                        height: control.lineWidth
                        anchors.verticalCenter: parent.verticalCenter
                        active: control.lineVisible && !__rootItem.hasChildren && !__rootItem.isRootNode
                        sourceComponent: LinkLine {
                            startX: control.lineWidth
                            startY: control.lineWidth
                            endX: width
    ...
    function checkForKeys(keys: var): void {
        __private.checkForKeys(keys);
    }

    function expandForKeys(keys: var): void {
        __private.expandForKeys(keys);
    }

    function expandToIndex(index: var): void {
        __treeView.expandToIndex(index);
    }

    function collapseToIndex(index: var): void {
    ...
    function appendNode(parentIndex: var, data: var): void {
    ...
    function removeNode(index: var): void {
        if (index.vaild) {
            __treeModel.removeRow(index);
        }
    }

    function moveNode(fromIndex: var, toIndex: var): void {
        const row = __treeModel.getRow(fromIndex);
        appendNode(toIndex);
        removeNode(fromIndex);
    }

    function setNodeData(index: var, data: var): void {
        if (index.vaild) {
    ...
    component LinkLine: Shape {
        ...
        ShapePath {
            strokeStyle: control.lineStyle === HusTree.LineSolid ? ShapePath.SolidLine : ShapePath.DashLine
