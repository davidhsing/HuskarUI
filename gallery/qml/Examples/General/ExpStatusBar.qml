...
HusStatusBar {
    model: [
        ...
        CodeBox {
            ...
            desc: qsTr('通过 `align` 属性指定每个格子的文本对齐方式,支持 `HusStatusBar.AlignLeft`、`HusStatusBar.AlignCenter`、`HusStatusBar.AlignRight`。')
            code:
                `import QtQuick
import HuskarUI.Basic
    ...
    model: [
        {
            text: "左对齐",
            width: 200,
            align: HusStatusBar.AlignLeft
        },
        {
            text: "居中对齐",
            width: -1,
            align: HusStatusBar.AlignCenter
        },
        {
            text: "右对齐",
            width: 200,
            align: HusStatusBar.AlignRight
        }
    ]
}`
            exampleDelegate: HusStatusBar {
                model: [
                    { text: "左对齐", width: 200, align: HusStatusBar.AlignLeft },
                    { text: "居中对齐", width: -1, align: HusStatusBar.AlignCenter },
                    { text: "右对齐", width: 200, align: HusStatusBar.AlignRight }
                ]
            }
        }
